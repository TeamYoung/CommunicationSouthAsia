...
--
-- Host: localhost
-- Generation Time: Jun 05, 2013 at 12:46 PM
...
--
-- Table structure for table `nepal_internet_data`
--

CREATE TABLE IF NOT EXISTS `nepal_internet_data` (
  `year` varchar(10) DEFAULT NULL,
  `ntc` int(7) DEFAULT NULL,
  `utl` int(5) DEFAULT NULL,
  `ncell` int(7) DEFAULT NULL,
  `isps` int(5) DEFAULT NULL,
  `total` int(7) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `nepal_internet_data`
--

INSERT INTO `nepal_internet_data` (`year`, `ntc`, `utl`, `ncell`, `isps`, `total`) VALUES
('2009-08-14', 121701, 24823, 332428, 62375, 541327),
('2010-02-14', 195239, 24823, 472375, 63000, 755437),
('2010-08-14', 320424, 24823, 1353845, 65000, 1764092),
('2011-02-14', 826861, 39257, 1336713, 65000, 2267831),
('2011-08-14', 1210225, 54175, 1957597, 54801, 3276798),
('2012-02-14', 1672046, 68477, 2389788, 62932, 4193243),
('2012-08-14', 2163639, 78388, 2829026, 74140, 5145193),
('2013-02-11', 2791030, 86866, 2934661, 79029, 5891586);

-- --------------------------------------------------------

--
-- Table structure for table `nepal_internet_penetration_data`
--

CREATE TABLE IF NOT EXISTS `nepal_internet_penetration_data` (
  `year` varchar(5) DEFAULT NULL,
  `users` int(7) DEFAULT NULL,
  `percent` decimal(10,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `nepal_internet_penetration_data`
--

INSERT INTO `nepal_internet_penetration_data` (`year`, `users`, `percent`) VALUES
('NTC', 2791030, '47.37'),
('UTL', 86866, '1.47'),
('NCELL', 2934661, '49.81'),
('ISPs', 79029, '1.34');
